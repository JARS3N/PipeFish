...
ggplot(XLev,aes(Tick,O2,Well)) +geom_line(aes(col=Well))+theme_bw()+ggtitle("O2 Levels")+scale_colour_continuous(guide = FALSE)
ggplot(XLev,aes(Tick,pH,Well)) +geom_line(aes(col=Well))+theme_bw()+ggtitle("pH Levels")+scale_colour_continuous(guide = FALSE)
